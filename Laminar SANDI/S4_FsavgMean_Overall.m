% Main script for computing depth-averaged group-mean fsaverage surface maps of
% laminar SANDI metrics
%
% Reference:
...
% - Depth-resolved Group-mean SANDI surface overlays resampled to fsaverage in FreeSurfer .mgz format
%
...
dpMean = fullfile(dproot,'/derivatives/SANDI/RF_Dis2/supres/surf/surf2Fsavg/GroupMean_Depth/Overall');
mkdir(dpMean)
...
for dep = 1:length(order)
    ...
    dpSurf2Fsavg_Overall = fullfile(dproot,'/derivatives/SANDI/RF_Dis2/supres/surf/surf2Fsavg/GroupMean_Depth');
